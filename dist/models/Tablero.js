...
import { TipoPieza, Color } from './types.js';
export class Tablero {
    ...
    caminoEstaLibre(origen, destino) {
        /*
        Propósito:
    ...
    coronarPeon(posicion, tipoPromocion) {
        /*
        Propósito:
    ...
    dejaAlReyEnJaque(origen, destino, color) {
        /*
        Propósito:
        ...
        */
        ...
        if (!piezaAMover || origen.fila === undefined || origen.columna === undefined || destino.fila === undefined || destino.columna === undefined)
            return false;
    ...
    esJugadaLegalSilenciosa(origen, destino, color) {
        /*
        Propósito:
        ...
        */
        ...
        const piezaEnDestino = this.obtenerPieza(destino);
        // Fuego amigo
        if (piezaEnDestino && piezaEnDestino.color === color)
            return false;
    ...
    evaluarEstadoDelJuego(colorTurnoActual) {
        /*
        Propósito:
    ...
    esCapturaAlPasoValida(origen, destino, peonAtacante) {
        /*
        Propósito:
    ...
    obtenerMovimientosPosibles(origen) {
        /*
        Propósito:
        ...
        */
        ...
        for (let f = 0; f < 8; f++) {
            for (let c = 0; c < 8; c++) {
                const destinoTemporal = { fila: f, columna: c };
        ...
        // ==========================================
        const destinosEstrictamenteLegales = [];
    ...
    caminoEstaDespejado(origen, destino) {
        /*
        Propósito:
    ...
    promoverPeon(posicion, nuevoTipo) {
        /*
        Propósito:
